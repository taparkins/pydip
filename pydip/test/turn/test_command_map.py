...
def test__move_command():
    ...
    command_map = CommandMap(map, [command])
...
def test__support_command():
    ...
    command_map = CommandMap(map, [move_command, support_command_1, hold_command, support_command_2])
...
def test__convoy_transport_command():
    ...
    command_map = CommandMap(map, [move_command, transport_command])
